...
PROJECT_REF="${PROJECT_REF:-iyeftdnenkzdjwfmkulm}"
PATCH_FILE="${1:-scripts/supabase/auth_email_templates_patch.json}"
BACKUP_FILE="scripts/supabase/auth_email_templates_backup_$(date +%Y%m%d_%H%M%S).json"
